...
import CombineHarvester.CombineTools.plotting as styles

label_dict = {
    "emtt": "e#mu_{}#tau_{h}#tau_{h}",
    "eett": "ee#tau_{h}#tau_{h}",
    "mmtt": "#mu_{}#mu_{}#tau_{h}#tau_{h}",
    "ettt": "e#tau_{h}#tau_{h}#tau_{h}",
    "mttt": "#mu_{}#tau_{h}#tau_{h}#tau_{h}",
    "ttt": "#tau_{h}#tau_{h}#tau_{h}",
...
def main(args):
    ...
    axis_label = "#sigma #times BR(#phi#rightarrow#tau#tau) #times BR(A#rightarrow#tau#tau) (pb)"
    ...
    mass_label = "m_{#phi} = 100 GeV, m_{A} = 100 GeV"
    if '_pt_' in channels[1]:
    ...
    styles.DrawTitle(canv, "138 fb^{-1} (13 TeV)", 3, 0.2)
