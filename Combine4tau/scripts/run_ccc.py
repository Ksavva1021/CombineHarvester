...
#os.system("combine -M ChannelCompatibilityCheckRegexGroup -d %(ws)s -m %(mass)s --setParameters %(setpar)s --setParameterRanges %(parranges)s --redefineSignalPOIs %(poi)s --X-rtd MINIMIZER_analytic --X-rtd FITTER_NEW_CROSSING_ALGO --cminDefaultMinimizerStrategy 0 --cminDefaultMinimizerTolerance 0.01 --robustFit 1 --stepSize 0.1 -n .CCC.channel --saveFitResult -g eett -g mmtt -g ettt -g mttt -g emtt -g ttt -g tttt -v 1 -t -1" % vars())
